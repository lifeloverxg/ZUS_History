...
<html lang="utf-8">
	<head>
		...
		<link rel="stylesheet" href="<?php echo $home . "theme/zus/mobile_version.css"; ?>">
				...
				<div class="nav-main">
					...
					<ul>
						<li<?php echo (preg_match("/\/event/i", $_SERVER['REQUEST_URI']) > 0)?" class='current'":""; ?>><a href="<?php echo $home . $links['event']; ?>">
							<figure id="header-tags-1">活动</figure>
						</a></li>
						<li<?php echo (preg_match("/\/group/i", $_SERVER['REQUEST_URI']) > 0)?" class='current'":""; ?>><a href="<?php echo $home . $links['group']; ?>">
							<figure id="header-tags-2">群组</figure>
						</a></li>
						<li<?php echo (preg_match("/\/people/i", $_SERVER['REQUEST_URI']) > 0)?" class='current'":""; ?>><a href="<?php echo $home . $links['people']; ?>">
							<figure id="header-tags-3">个人</figure>
						</a></li>
						<li<?php echo (preg_match("/\/information/i", $_SERVER['REQUEST_URI']) > 0)?" class='current'":""; ?>><a href="<?php echo $home . $links['faq']; ?>">
							<figure id="header-tags-4">综合</figure>
						</a></li>
					</ul>
				</div>
...
<?php if (isset($_SESSION['auth'])) { ?>
					...
					<div class="panel-user-main">
						<a href="<?php echo $home . $links['people']; ?>">
							<span>欢迎回来，</span><span class="panel-user-name"><?php echo $auth['title']; ?></span>
