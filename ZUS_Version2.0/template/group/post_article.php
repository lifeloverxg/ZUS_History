    ...
    <section class="popup-main">
            ...
            <article class="post-article">
			     <form class="articleForm" name="articleForm" method="post" action="" enctype="multipart/form-data" onSubmit="return chk_article(this)">            
                    ...
                    <p>文章标题: </p>
                    	<input name="article_title" type="text" class="article-title"/>
              		
              		<p>分类: </p>
              			<select name="article_category" class="article-category">
...
<?php } ?>
              		...
              		<p>标签</p>
              			<input name="article_tag" type="text" class="article-tag"/>
              		
              		<p>阅读权限</p>
              		<select name="article_privacy" class="article-privacy">
...
<?php } ?>
                	...
                	<p>正文: </p>
                		<textarea name="article_content" class="article-content" id="article-content" placeholder="正文" title="正文"></textarea>
