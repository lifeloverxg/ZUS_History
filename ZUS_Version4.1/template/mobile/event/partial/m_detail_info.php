...
<div class="info-list-large">
	...
	<div class="info-content-large" id="hide-text"><?php echo $info_list['活动描述']; ?></div>
</div>
<div class="info-list-small">
...
<?php
	...
	m_down_list::render($m_member_list, 'member_list?eid='.$eid);
?>
</div>
<div class="info-list-small">
...
<?php
	$m_photo_list = array();
	foreach (array_slice($photo_list, 0, 8) as $photo_item) {
