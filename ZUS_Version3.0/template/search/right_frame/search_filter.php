...
<?php if ( isset($filter_list) && !empty($filter_list) ) { ?>
		<div class="search-right-filter">
			<span style="display: block; float: left; color: white; margin-right: 10px; background: #00A79D; border: 1px solid #eee; line-height: 30px; width: 50px; text-align: center; border-radius: 5px;">Filter: </span>
