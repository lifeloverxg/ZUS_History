    ...
    <section class="popup-main">
        ...
        <article class="edit-event-form">
			<form class="modifyForm" name="modifyForm" method="post" action="" enctype="multipart/form-data" onSubmit="return chk_modify(this)">
                ...
                <p>活动名称: </p>
                <input name="edit_title" type="text" class="modify_form_class" placeholder="活动名称" value="<?php echo $info_list['title'];?>" maxlength="20"/>
...
<?php foreach($address as $key => $value) { ?>
                <input name="edit_location_<?php echo $key; ?>" type="text" class="modify_form_class" placeholder="<?php echo $key; ?>" value="<?php echo $value; ?>" maxlength="100"/>
<?php } ?>        
