...
<?php foreach ($gender_list as $gender_id => $gender_name) {
	if ((!empty($info_list['性别']) && $gender_name == $info_list['性别']) || (empty($info_list['性别']) && $gender_id == Gender::Unknown)) {
?>
...
?>
                ...
                <p>学校: </p>
                <input name="edit_education" type="text" class="modify_form_class" value="<?php echo (isset($info_list['学校'])?$info_list['学校']:''); ?>" maxlength="30"/>
              
              
              
                <p>家乡: </p>
                 <input name="edit_hometown" type="text" class="modify_form_class" value="<?php echo (isset($info_list['家乡'])?$info_list['家乡']:''); ?>" maxlength="30"/>
                
              
              
              
                <p>爱好: </p>
                <input name="edit_hobby" type="text" class="modify_form_class" value="<?php echo (isset($info_list['爱好'])?$info_list['爱好']:''); ?>" maxlength="30"/>
                
                
                <p>生日: </p>
                <div class="birth_time">
                    <input type="text" name="edit_birth" id="datetimepicker-start" class="modify_form_class" value="<?php echo (isset($info_list['生日'])?$info_list['生日']:''); ?>"/> 
                </div>              
              
              
                <p>婚姻状况: </p>
                <input name="edit_marriage" type="text" class="modify_form_class" value="<?php echo (isset($info_list['婚姻状况'])?$info_list['婚姻状况']:''); ?>" maxlength="30"/>
                
  
                <p>电话: </p>
                <input name="edit_phone" type="text" class="modify_form_class" value="<?php echo (isset($info_list['电话'])?$info_list['电话']:''); ?>" maxlength="30"/>

              
                <p>邮箱: </p>
                <input name="edit_email" type="email" class="modify_form_class" value="<?php echo (isset($info_list['邮箱'])?$info_list['邮箱']:''); ?>" maxlength="30"/>
                
              

                <p>地址: </p>
                <input name="edit_address" type="text" class="modify_form_class" value="<?php echo (isset($info_list['地址'])?$info_list['地址']:''); ?>" maxlength="30"/>
