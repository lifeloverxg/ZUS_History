				...
				<section class="section-login_panel">
					...
					<article class="article-login_panel">
						<div class="div-signin <?php echo ($side<=0)?"back":""; ?>">
							<input type="text" name="username" required placeHolder="用户名/邮箱" value="<?php if ( isset($cookieuser) ) {echo $cookieuser;} ?>" onkeyup="if(event.which == 13){signin()}else{}"><br>
							<input type="password" name="pass" required placeHolder="密码" value="<?php if ( isset($cookiepass) ){echo $cookiepass;} ?>" onkeyup="if(event.which == 13){signin()}else{}"><br>
							...
							<div class="div-signup <?php echo ($side>=1)?"back":""; ?>">
								<input type="email" name="email" required placeHolder="邮箱" onkeyup="if(event.which == 13){signup()}else{}"><br>
								<input type="text" name="username" required placeHolder="用户名" onkeyup="if(event.which == 13){signup()}else{}"><br>
								<input type="password" name="pass" required placeHolder="密码" onkeyup="if(event.which == 13){signup()}else{}"><br>
								<input type="password" name="pass2" required placeHolder="确认密码" onkeyup="if(event.which == 13){signup()}else{}"><br>
								<ul class="ul-error-message"></ul>
